...
describe.skip('Auth Routes', () => {
  ...
  const mockUser = {
    ...
    isHRAdmin: jest.fn().mockReturnValue(false),
    isSafetyAdmin: jest.fn().mockReturnValue(false),
    isHR: jest.fn().mockReturnValue(false),
  ...
  const mockOrganization = {
    ...
    isActive: true,
    isOrganizationActive: jest.fn().mockReturnValue(true),
    hasEmailDomain: jest.fn().mockReturnValue(true),
    isEmailInDomain: jest.fn().mockReturnValue(true),
    toJSON: jest.fn().mockReturnValue({}),
    createdAt: new Date(),
    updatedAt: new Date(),
  };
